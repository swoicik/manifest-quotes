...
<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	<div class="post-content">
		...
		?>
		<h3 class="entry-title"><a href="<?php echo esc_attr( $link_url ); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'manifest' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_title(); ?></a></h3>
